...
<div id="wrapper">
  ...
  <ul class="nav nav-pills">
    ...
    <li class="btn btn-default btn-xs"><a href="bill.php"><span class="glyphicon glyphicon-btc"></span>&nbsp;Billing</a></li>
...
while($row = mysql_fetch_array($result))
 ...
 echo "<td><a rel='facebox' href='paybill.php?id=".$row['id']."'><span class=\"btn btn-info btn-xs\">Run</span> </a>| ";
