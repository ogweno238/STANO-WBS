...
<title>Stano Water Billing System</title>
<style type="text/css">
#wrapper{
 width:100%;
 margin:0 auto;
...
<div class="container">
<div id="wrapper">
  <h1><center><b>Stano Online Water Billing System</b></center></h1>
  <div style="color:#F00; font-size:12px; margin-left:800px;"> 
  <span></span><a href="logout.php"><span class="btn btn-danger  glyphicon glyphicon-log-out">&nbsp;Logout</span></a>
  </div>
  <ul class="nav nav-pills">
    <li><a href="billing.php"><span class="glyphicon glyphicon-home"></span>&nbsp;Home</a></li>
    <li><a href="bill.php"><span class="glyphicon glyphicon-btc"></span>&nbsp;Billing</a></li>
    ...
    <div class="modal-dialog" style="width:400px;">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Stano Water Billing System</h4>
        </div>
  ...
  <!-------------------------- modal ends ---------------------------->
         ...
         <div class="panel panel-info">
            <div class="panel-heading">
                ...
                <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal"> + Add Clients</button>
