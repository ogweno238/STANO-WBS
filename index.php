<?php include("header.php"); ?>
  <body style=" background:url(img/wbs.jpg); background-repeat: no-repeat;
  background-size: cover; heigh:350px">
    ...
    <div class="container">    
        <div id="loginbox" style="margin-top:200px; margin-right:800px; width:450px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
            <div class="panel panel-info"  style=" background:url(img/WaterMeter.gif); background-size:cover; background-repeat: no-repeat;">
